                        ...
                        <form method="POST" action="{{ route('pengajaran.update', $gose->id) }}" enctype="multipart/form-data">
                          ...
                          <div class="form-group row">
                            <div class="col-md m-3">
                              ...
                              <input type="text" class="form-control" id="instansi" name="instansi" value="{{ $gose->userdosen1->name }}">
                            </div>
                            <div class="col-md m-3">
                              <label for="instansi">Dosen II</label>
                              <input type="text" class="form-control" id="instansi" name="instansi" value="{{ $gose->userdosen2 ? $gose->userdosen2->name : '' }}">
                            </div>
                            <div class="col-md m-3">
                              <label for="instansi">Dosen III</label>
                              <input type="text" class="form-control" id="instansi" name="instansi" value="{{ $gose->userdosen3 ? $gose->userdosen3->name : '' }}">
                            </div>
                          </div>
                          <div class="form-group row">
                            <div class="col-md m-3">
                    ...
                    <div class="modal-body">
                      <form method="POST" action="{{ route('pengajaran.update', $gose->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                          <div class="col-md m-3">
                            <label for="instansi">Dosen Koordinator</label>
                            <input type="text" class="form-control" id="instansi" name="instansi" value="{{ $gose->dosen_1 }}">
                          </div>
                        ...
                        <div class="form-group row">
                          <div class="col-md m-3">
                            <label for="instansi">Dosen II</label>
                            <input type="text" class="form-control" id="instansi" name="instansi" value="{{ $gose->dosen_2 }}">
                          </div>
                        </div>
                        <div class="form-group row">
                          <div class="col-md m-3">
                            <label for="instansi">Dosen III</label>
                            <input type="text" class="form-control" id="instansi" name="instansi" value="{{ $gose->dosen_3 }}">
                          </div>
                        </div>
                        <div class="form-group row">
                          <div class="col-md m-3">
