...
<?php
$px = $dokumenpenunjang[0]; // Take the first value from the $pendidikan array
?>
                        ...
                        <form method="POST" action="{{route('doumenpenunjang.update', $dp->id)}}" enctype="multipart/form-data" >
                          ...
                          <div class="form-group row">
                              <div class="col-md m-3">
                                  ...
                                  <input type="text" class="form-control" id="kedudukan_dp" name="kedudukan_dp" value="{{ $dp->kedudukan_dp }}">
                              </div>
                  
                  
                              <div class="col-md m-3">
                                  <label for="instansi_dp">Instansi</label>
                                  <input  type="text" class="form-control" id="instansi_dp" name="instansi_dp" value="{{ $dp->instansi_dp }}">
                              </div>
                          </div>
                          ...
                          <div class="form-group row">
                              <div class="col-md m-3">
                                  ...
                                  <input type="date" class="form-control" id="tanggal_pelaksanaan_dp" name="tanggal_pelaksanaan_dp" value="{{ $dp->tanggal_pelaksanaan_dp }}">
                              </div>
                              <div class="col-md m-3">
                                  <label for="angkakredit_dp">Angka Kredit</label>
                                  <input readonly type="integer" class="form-control" id="angkakredit_dp" name="angkakredit_dp" value="{{ $dp->angkakredit_dp }}">
                              </div>
                          </div>
                          ...
                          <div class="form-group ">
                            <div class="com-md m-3">
                              ...
                              <input class="form-control @error('buktidp') is-invalid @enderror" type="file" id="buktidp" name="buktidp" value="{{ $dp->buktidp }}">
                              @error('buktidp')
